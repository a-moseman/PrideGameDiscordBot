...
public class Dice {
    ...
    protected static final Dice D2 = new Dice(new long[]{1, 0, 0, 0, 0, 0, 0});
    protected static final Dice D4 = new Dice(new long[]{1, 1, 0, 0, 0, 0, 0});
    protected static final Dice D6 = new Dice(new long[]{0, 0, 1, 0, 0, 0, 0});
    protected static final Dice D8 = new Dice(new long[]{0, 0, 0, 1, 0, 0, 0});
    protected static final Dice D10 = new Dice(new long[]{0, 0, 0, 0, 1, 0, 0});
    protected static final Dice D12 = new Dice(new long[]{0, 0, 0, 0, 0, 1, 0});
    protected static final Dice D20 = new Dice(new long[]{0, 0, 0, 0, 0, 0, 1});


    protected Dice(long[] diceCounts) {
        assert diceCounts.length == DICE_COUNT;
